...
model = load_model(
    r"D:\Desktop\DataSentience-AIML\src\Agricultural Solutions\Crop_Yield_Prediction_ANN\my_model (1).keras",
    compile=False
)
preprocessor = joblib.load(r"D:\Desktop\DataSentience-AIML\src\Agricultural Solutions\Crop_Yield_Prediction_ANN\preprocessor (1).pkl")
y_scaler=joblib.load(r"D:\Desktop\DataSentience-AIML\src\Agricultural Solutions\Crop_Yield_Prediction_ANN\y_scaler (2).pkl")
